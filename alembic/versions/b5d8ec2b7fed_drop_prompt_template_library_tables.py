"""drop prompt template library tables

Template library has been migrated to idea-generator-web.
These tables are no longer used in this project.

Revision ID: b5d8ec2b7fed
Revises: a4c7cb1a6dbc
