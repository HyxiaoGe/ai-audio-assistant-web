...
from sqlalchemy import DateTime, String, ForeignKey, Text, Index, text
...
class Notification(BaseRecord):
    ...
    task: Mapped[Optional["Task"]] = relationship("Task", back_populates="notifications")  # type: ignore
    ...
    def __repr__(self) -> str:
        return f"<Notification(id={self.id}, user_id={self.user_id}, category={self.category}, action={self.action}, read={self.read_at is not None})>"
